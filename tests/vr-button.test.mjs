...
for (const name of ['openspace', 'lookandsay', 'lanternlake', 'mriprep']) {
  ...
  assert(html.includes('href="/xr-shared/vr-button.css?v=20260911"'), `${name}: shared styling`);
...
assert(look.includes('body > *:not(#room):not(.revivr-vr-button)'), 'Room layering must not override fixed VR button positioning');
